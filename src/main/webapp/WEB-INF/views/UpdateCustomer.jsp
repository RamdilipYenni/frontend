...
<div class="container">
  ...
  <form class="form-horizontal" action="UpdateCustomer" method="post">
    <div class="form-group">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" readonly id="supid" value="${CustomerInfo.CustomerId}" name="supid">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="email">Customer Name:</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" id="supname" value="${CustomerInfo.CustomerName}" name="supname">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="email">Customer Address:</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" id="supadd" value="${CustomerInfo.CustomerAddress}" name="supadd">
      </div>
    </div>
